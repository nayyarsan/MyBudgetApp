  ...
  group('RebalanceSuggestion logic', () {
    test('no suggestions when nothing is overspent', () {
      final suggestions = computeRebalanceSuggestions(
        categoryData: [
          const CategoryBudgetData(id: 1, name: 'Groceries', assigned: 40000, spent: 30000),
          const CategoryBudgetData(id: 2, name: 'Dining', assigned: 20000, spent: 15000),
        ],
      );
    ...
    test('suggests pulling from surplus to cover overage', () {
      final suggestions = computeRebalanceSuggestions(
        categoryData: [
          const CategoryBudgetData(id: 1, name: 'Groceries', assigned: 40000, spent: 50000), // -$100 overage
          const CategoryBudgetData(id: 2, name: 'Dining', assigned: 20000, spent: 5000),     // +$150 surplus
        ],
      );
    ...
    test('caps transfer at available surplus', () {
      final suggestions = computeRebalanceSuggestions(
        categoryData: [
          const CategoryBudgetData(id: 1, name: 'Groceries', assigned: 40000, spent: 70000), // -$300 overage
          const CategoryBudgetData(id: 2, name: 'Dining', assigned: 20000, spent: 10000),    // +$100 surplus only
        ],
      );
